...
const signupTestURL =
    'https://ezmock.herokuapp.com/api/623a05f4fa803c0015c625ea';
const loginTestURL =
    'https://run.mocky.io/v3/29bd5f9e-a0ac-4ba0-9219-ce44ee001501';
const allTasksTestURL =
    'https://run.mocky.io/v3/bbbee1b4-2427-4424-929d-b4332e839754';
const singleTaskTestURL =
    'https://run.mocky.io/v3/2a4db3d0-4536-40d9-b6fd-47a4caf1a6e6';
const logoutTestURL = '';
const getUserURL =
    'https://run.mocky.io/v3/13c5b982-4841-4b8a-8544-8cb35871ec70';
...
export default class ExternalServices {
    ...
    async loginRequest(user) {
        ...
        if (!TESTING) {
            ...
            response = await fetch(loginTestURL).then(convertToJson);
            response.user_id = 0;
        }
            ...
            await fetch(baseURL + 'signup', options).then((response) => {
                ...
                if (typeof response === 'string') {
                    ...
                    responseInfo.errorMessage =
                        'Fill out all the information please';
                }
            });
        } else {
            responseInfo.signupSuccess = true;
